    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/appsoluut/jacococandroidtest/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/appsoluut/jacococandroidtest.git")
                    developerConnection.set("scm:git:ssh://github.com/appsoluut/jacococandroidtest.git")
                    url.set("https://github.com/appsoluut/jacococandroidtest/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/appsoluut/jacococandroidtest/issues")
                }
            }
        }
    }
